...
{
    public function zr400polyview (Request $request)    
    {         
      $idmachineno = $request->mesin_no;
      $idmachines = 1;
      $idmachinedetails = 2;
      $machinedetailnos = machinedetailno::select ('*') ->where ('idmachine', '=',1)->where ('idmachinedetails', '=',2)->get(); 
      if ($request->has('mesin_no')){
    ...
    return view('jobs.zr400polyview', compact('datajobs','machinedetailnos')
      ,['idmachines' => $idmachines,'idmachinedetails' => $idmachinedetails,'idmachineno' => $idmachineno]);
    }    

    public function edit400poly(job $job)
    {
      $grupleaders = employee::select ('employee# as employeeid','surname')->where ('jabatan', '=','G')->get();
      $supervisors = employee::select ('employee# as employeeid','surname')->where ('jabatan', '=','S')->get();    
      //dd ($job);
      $machinedetailnos = machinedetailno::select ('*') ->where ('idmachine', '=',1)->where ('idmachinedetails', '=',2) ->get();               
    ...
    {       
     ...
     //   dd ($vtime)
      ...
      public function polyview (Request $request)    
      {         
      $idmachineno = $request->mesin_no;
      $idmachines = 1;
      $idmachinedetails = 1;
...
//            dd ($vtime);
    ...
    public function kaeserview(Request $request)    
    {         
      $idmachineno = $request->mesin_no;
      $idmachines = 1;
      $idmachinedetails = 3;
    ...
    public function elliotview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;    
      $idmachines = 1;
      $idmachinedetails = 4;
    ...
    public function cvgd390view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 2;
      $idmachinedetails = 1;
    ...
    public function cvhe330590view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 2;
      $idmachinedetails = 2;
    ...
    public function ac_unit_polyview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 3;
      $idmachinedetails = 1;
    ...
    public function dryer_polyview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 4;
      $idmachinedetails = 1;
    ...
    public function trafoview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 6;
      $idmachinedetails = 1;
    ...
    {               
        ...
        public function ahu_spinning1view (Request $request)    
        {         
        $idmachineno = $request->mesin_no;
          $idmachines = 5;
          $idmachinedetails = 1;
    ...
    public function n2_plantview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 8;
      $idmachinedetails = 1;
    ...
    public function deminwaterview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 7;
      $idmachinedetails = 1;
    ...
    public function compressordty1view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 9;
      $idmachinedetails = 1;
    ...
    ,['idmachines' => $idmachines,'idmachinedetails' => $idmachinedetails,'idmachineno' => $idmachineno]);
      ...
      public function zr425view (Request $request)    
      {         
      $idmachineno = $request->mesin_no;
        $idmachines = 10;
        $idmachinedetails = 1;
    ...
    public function elliotplf2view(Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 10;
      $idmachinedetails = 2;
    ...
    public function dryerfd1600plf2view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 11;
      $idmachinedetails = 1;
    ...
    public function chillercvhe590view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 12;
      $idmachinedetails = 1;
    ...
    public function ahu_spinning2view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 13;
      $idmachinedetails = 1;
    ...
    public function trafogensetview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 16;
      $idmachinedetails = 1;
  ...
  ,['idmachines' => $idmachines,'idmachinedetails' => $idmachinedetails,'idmachineno' => $idmachineno]);
    ...
    public function dieselengine1view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 17;
      $idmachinedetails = 1;
    ...
    public function dieselengine2view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 17;
      $idmachinedetails = 2;
    ...
    public function gasengine1view(Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 18;
      $idmachinedetails = 1;
    ...
    public function gasengine2view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 18;
      $idmachinedetails = 2;
    ...
    public function chemicalview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 19;
      $idmachinedetails = 1;
    ...
    public function panelstarterview(Request $request)    
    {         
    $idmachineno = $request->mesin_no;
        $idmachines = 20;
        $idmachinedetails = 1;
    ...
    public function auxiliary1view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 21;
      $idmachinedetails = 1;
    ...
    {               
        ...
        public function auxiliary2view (Request $request)    
        {         
        $idmachineno = $request->mesin_no;
          $idmachines = 21;
          $idmachinedetails = 2;
    ...
    public function flowmeterview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 22;
      $idmachinedetails = 1;
    ...
    public function wwtview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 23;
      $idmachinedetails = 1;
    ...
    public function paramwwtview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 23;
      $idmachinedetails = 2;
  ...
  ,['idmachines' => $idmachines,'idmachinedetails' => $idmachinedetails,'idmachineno' => $idmachineno]);
    ...
    public function dailyreportview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 23;
      $idmachinedetails = 3;
    ...
    public function trafowwtview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 24;
      $idmachinedetails = 1;
    ...
    public function dryerdty1view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 25;
      $idmachinedetails = 1;
    ...
    public function chillercvhe530view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 26;
      $idmachinedetails = 1;
    ...
    public function ac_stationplf2 ()
    {               
        $vtime = date('H');
        //   dd ($vtime)
           if ($vtime > 7 && $vtime <= 15) 
        ...
        $machinedetailnos = machinedetailno::select ('*') ->where ('idmachine', '=',31)->where ('idmachinedetails', '=',1) ->get(); 
        $kode = DB::table('jobs')->max('id');
      	$kode = (int) $kode + 1;
        $uk =  Auth::user()->unique_karyawan;
        $grupleaders = employee::select ('employee# as employeeid','surname')->where ('jabatan', '=','G')->get();
        ...
        $employeeids = employee::select ('*')->where ('employee#', '=',$uk)->get();
        return view ('jobs.ac_stationplf2',compact ('machinedetailnos','employeeids','grupleaders','supervisors'),
        ['kode' => $kode,'uk' => $uk,'shift' => $shift]
        );                
    }

    public function ac_stationview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 27;
      $idmachinedetails = 1;
    ...
    public function editac_station(job $job)
    {
      ...
      $employeeids = employee::select ('*')->where ('employee#', '=',$uk)->get();
      return view('jobs.editac_station', compact('job','machinedetailnos','employeeids','grupleaders','supervisors'),['uk' => $uk]);    
    }
    ...
    public function ac_stationplf2view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 31;
      $idmachinedetails = 1;
    ...
    return view('jobs.ac_stationplf2view', compact('datajobs','machinedetailnos')
    ,['idmachines' => $idmachines,'idmachinedetails' => $idmachinedetails,'idmachineno' => $idmachineno]);
    }

    public function editac_stationplf2(job $job)
    {
      $grupleaders = employee::select ('employee# as employeeid','surname')->where ('jabatan', '=','G')->get();
      $supervisors = employee::select ('employee# as employeeid','surname')->where ('jabatan', '=','S')->get();    
      ...
      $employeeids = employee::select ('*')->where ('employee#', '=',$uk)->get();
      return view('jobs.editac_stationplf2', compact('job','machinedetailnos','employeeids','grupleaders','supervisors'),['uk' => $uk]);    
    }

    public function updateac_stationplf2(job $Job)
    {
      $tgl1 =request('tanggal');                
      $tgl =carbon::parse($tgl1)->format('Y-m-d H:i:s');
      $current_date_time = date('Y-m-d H:i:s');
      ...
      return redirect()->route('jobs.ac_stationplf2view')->with('success','Data was Updated');
    ...
    public function trafodty1view (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 28;
      $idmachinedetails = 1;
    ...
    public function edittrafodty1(job $job)
    {
      ...
      $employeeids = employee::select ('*')->where ('employee#', '=',$uk)->get();
      return view('jobs.edittrafodty1', compact('job','machinedetailnos','employeeids','grupleaders'),['uk' => $uk]);    
    }
    ...
    public function wtview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 29;
      $idmachinedetails = 1;
    ...
    public function garduindukview (Request $request)    
    {         
    $idmachineno = $request->mesin_no;
      $idmachines = 30;
      $idmachinedetails = 1;
...
if ($idmachines == 1 && $idmachinedetails == 1) {            
         $pdf = PDF::loadView('jobs.datajobs',['idmachine'=>$idmachines,'idmachinedetails'=>$idmachinedetails])->setOptions(['defaultFont' => 'sans-serif']); 
         return $pdf->setPaper('A1', 'landscape')->stream('data.pdf',array('Attachment' => false));//download('data.pdf');         
        }
         ...
         return $pdf->setPaper('A1', 'landscape')->stream('data.pdf',array('Attachment' => false));//download('data.pdf');
          ...
          return $pdf->setPaper('A1', 'landscape')->stream('data.pdf',array('Attachment' => false));//download('data.pdf');
            ...
            else if ($idmachines == 31 && $idmachinedetails == 1) {
                   $pdf = PDF::loadview('jobs.dataac_stationplf2',['idmachine'=>$idmachines,'idmachinedetails'=>$idmachinedetails]);
                   return $pdf->setPaper('A1', 'landscape')->stream('data.pdf',array('Attachment' => false));//download('data.pdf');      
...
public function storeac_stationplf2 ()
{
    request()-> validate(            
        ['id' => 'required',
            'tanggal' => 'required',
    ...
    return redirect()->route('jobs.ac_stationplf2view')->with('success','Data was Created');   
}
