...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.editcvhe330590',$job) }}" method="post" enctype ="multipart/form-data">  
        @csrf
        @method('put')
        ...
        <div class="form-group">
          ...
          <input type="number"  name="param2" value = '{{ $job->param2 }}' id="param2" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param2')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param2')
        ...
        <div class="form-group">
          ...
          <input type="number"  name="param3"  value = '{{ $job->param3 }}' id="param3" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param3')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param3')
