...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.editwt',$job) }}" method="post">
        @csrf
        @method('put')
        ...
        @error ('param11')
          ...
          <select name="param12" value="{{ $job->param12 }}">
        ...
        @error ('param12')
          ...
          <select name="param13" value="{{ $job->param13 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param13')
          ...
          <select name="param14" value="{{ $job->param14 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param14')
          ...
          <select name="param15" value="{{ $job->param15 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param15')
          ...
          <select name="param16" value="{{ $job->param16 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param16')
          ...
          <select name="param17" value="{{ $job->param17 }}" >
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param17')
          ...
          <select name="param18" value="{{ $job->param18 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param18')
          ...
          <select name="param19" value="{{ $job->param19 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param19')
          ...
          <select name="param20" value="{{ $job->param20 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param20')
          ...
          <select name="param21" value="{{ $job->param21 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param21')
          ...
          <select name="param22" value="{{ $job->param22 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('param22')
          ...
          <select name="param23" value="{{ $job->param23 }}">
        ...
        @error ('param24')
          ...
          <select name="param25" value="{{ $job->param25 }}">
             <option value="1">RUNNING </option>
             <option value="2">STANDBY</option>
             <option value="3">SERVICE</option>
          </select>
        ...
        @error ('chemical')
          ...
          <input type="text" name="scfilter" id="scfilter" value="{{ $job->scfilter }}" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('scfilter')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('scfilter')
        ...
        @error ('softener')
          ...
          <input type="text" name="bak_sedimentasi" id="bak_sedimentasi" value="{{ $job->bak_sedimentasi }}" class="form-control @error('') is invalid @enderror">
        </div>
