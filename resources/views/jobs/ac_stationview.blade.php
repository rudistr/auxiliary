...
@section('content')
<div class="container">
<a href="{{ route('jobs.ac_station')  }}" class="btn btn-success">Create</a>
<div class="row g-3 align-items-center mt-2">
  <div class="col-auto">
 <form action="{{ route('jobs.ac_stationview') }}" method="GET">        
    ...
    <table class="table table-dark table-striped">        
     <thead>
         <tr>
           ...
           <th>Time</th>
           <th>Machine No.</th>
           <th>INSTRUMENT MAIN PRESS(Max:2Bar)</th>           
           <th>INSTRUMENT DEW POINT PRESS(Max:Bar)</th>
           <th>SPRAY WTR.PRESS(1,5-2Bar)</th>
           <th>RH ROOM CONDITION (55-80%) </th>
           <th>TEMP.ROOM CONDITION<(25+/-4C)/th>
...
<tbody>
    @foreach($datajobs as $index => $job)
     ...
     <td>{{ $job->remarks }}</td>
     <td>
       <a href="{{ route('jobs.editac_station',$job->id) }}" class="btn btn-primary btn-sm">Edit</a>       
     </td>                  
    <tr>
    @endforeach
</tbody>
