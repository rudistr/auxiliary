...
@section('content')
<div class="card">
    <div class="card-header">TRAFO</div>       
    <div class="card-body">
    <form action="{{ route('jobs.edittrafowwt',$job) }}" method="post">
        @csrf
        @method('put')
        ...
        <div class="form-group">
          <label for="idmachineno">TRAFO/PE</label>
        ...
        @error ('noise')
          ...
          <div class="form-group">
          <label for="panel_pe_condition">PANEL CONDITION </label>
