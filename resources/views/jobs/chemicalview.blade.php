...
@section('content')
<div class="container">
<a href="{{ route('jobs.chemical')  }}" class="btn btn-success">Create</a>
<div class="row g-3 align-items-center mt-2">
  <div class="col-auto">
 <form action="{{ route('jobs.chemicalview') }}" method="GET">        
...
<tbody>
    @foreach($datajobs as $index => $job)
     ...
     <td>{{ $job->spv }}</td>
     <td>
       <a href="{{ route('jobs.editchemical',$job->id) }}" class="btn btn-primary btn-sm">Edit</a>       
     </td>                  
    <tr>
    @endforeach
</tbody>
