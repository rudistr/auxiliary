...
@section('content')
<div class="container">
<a href="{{ route('jobs.zr400poly')  }}" class="btn btn-success">Create</a>

<div class="row g-3 align-items-center mt-2">
  <div class="col-auto">
 <form action="{{ route('jobs.zr400polyview') }}" method="GET">        
  ...
  <button type="submit" class="btn btn-primary col-md-4"><i class="fa fa-print"></i> Filter </button>
    ...
    <div class="card-header">DATA ZR 400 POLY</div>       
    <div class="card-body">
     ...
     <thead>
         <tr>
          <th>No</th>
           <th>Time</th>
           <th>Machine No.</th>
           <th>Pres Comp.Outlet(Max:10Bar)</th>           
           <th>Press.DP Air Filter(Max:10Bar)</th>
           <th>OIL PRES(Max:10Bar)</th>
           <th>COOLING WATER TEMP(Max:30C)</th>
           <th>LP OUT TEMP(Max:30C)</th> 
           <th>Out Temp(max:50C)</th>
           <th>Oil Temp(Max:50C)</th>
           <th>Intercoller Press(2-3 Bar)</th>
           <th>Running Hours</th>           
           <th>Running Load</th>
           ...
           <th>KWH</th>
           <th>Element 1 Out Temp(Max :230c)</th>
           <th>Element 2 In Temp(Max:50C)</th>
           <th>Element 2 Out Temp(Max:230C)</th>
           <th>Comp Out Temp(Max:50C)</th>
...
<tbody>
    @foreach($datajobs as $index => $job)
     ...
     <td>{{ $job->remarks }}</td>
     <td>
       <a href="{{ route('jobs.edit400poly',$job->id) }}" class="btn btn-primary btn-sm">Edit</a>       
     </td>                  
    <tr>
    @endforeach
</tbody>
