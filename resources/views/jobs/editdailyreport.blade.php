...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.editdailyreport',$job) }}" method="post">
        @csrf
        @method('put')
        ...
        @error ('param2')
          ...
          <input type="text" name="param3" value = "{{ $job->param3 }}" id="param3" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param3')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param3')
