...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.editdieselengine1',$job) }}" method="post">
        @csrf
        @method('put')
        ...
        @error ('param19')
          ...
          <input type="number"  name="param20" id="param20" value = "{{ $job->param20 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param20')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param20')
          ...
          <input type="number"  name="param21" id="param21" value = "{{ $job->param21 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param21')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param21')
        ...
        @error ('param45')
          ...
          <input type="number"  name="param46" value = "{{ $job->param46 }}" id="param46" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param46')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param46')
        ...
        @error ('param47')
          ...
          <input type="number"  name="param48" id="param48" value = "{{ $job->param48 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param48')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param48')
          ...
          <input type="number"  name="param49" id="param49" value = "{{ $job->param49 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param49')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param49')
          ...
          <input type="number"  name="param50" id="param50" value = "{{ $job->param50 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param50')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param50')
          ...
          <input type="number"  name="param51" id="param51" value = "{{ $job->param51 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param51')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param51')
          ...
          <input type="number"  name="param52" id="param52" value = "{{ $job->param52 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param52')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param52')
          ...
          <input type="number"  name="param53" id="param53" value = "{{ $job->param53 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param53')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param53')
          ...
          <input type="number"  name="param54" id="param54" value = "{{ $job->param54 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param54')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param54')
          ...
          <input type="number"  name="param55" id="param55" value = "{{ $job->param55 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param55')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param55')
          ...
          <input type="number"  name="param56" id="param56" value = "{{ $job->param56 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param56')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param56')
          ...
          <input type="number"  name="param57" id="param57" value = "{{ $job->param57 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param57')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param57')
          ...
          <input type="number"  name="param58" id="param58" value = "{{ $job->param58 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param58')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param58')
          ...
          <input type="number"  name="param59" id="param59" value = "{{ $job->param59 }}" class="col-sm-5 form-control @error('') is invalid @enderror">
        </div>
        @error ('param59')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param59')
        ...
        @error ('overall_result')
         ...
         <div class="form-group">
          <label for="supervisor">Supervisor </label>
          <input type="text" name="supervisor" id="supervisor" value = "{{ $job->supervisor }}" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('supervisor')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('supervisor')
