...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.dailyreport') }}" method="post">
        @csrf
        ...
        @error ('idmachineno')
          ...
          <div class="form-group">
          <label for="param1">LEVEL BAK EMERGENCY</label>
          <input type="text" name="param1" id="param1" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param1')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param1')
          ...
          <div class="form-group">
          <label for="param2">LEVEL BAK EQUALISASI </label>
          <input type="text" name="param2" id="param2" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param2')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param2')
          ...
          <div class="form-group">
          <label for="param3">LEVEL BAK AERASI </label>
          <input type="text" name="param3" id="param3" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param3')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param3')
          ...
          <div class="form-group">
          <label for="param4">KONDISI LIMBAH EMERGENCY</label>
          <input type="text" name="param4" id="param4" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param4')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param4')
          ...
          <div class="form-group">
          <label for="param5">PROSES AERASI </label>
          <input type="text" name="param5" id="param5" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param5')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param5')
          ...
          <div class="form-group">
          <label for="param6">PROSES SEDIMENTASI </label>
          <input type="text" name="param6" id="param6" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param6')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param6')
          ...
          <div class="form-group">
          <label for="param7">PROSES FLOKULASI </label>
          <input type="text" name="param7" id="param7" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param7')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param7')
