...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.editcvgd390',$job) }}" method="post" enctype ="multipart/form-data">  
        @csrf
        @method('put')
        ...
        <div class="form-group">
          ...
          <select name="idmachineno" id="idmachineno" value='{{ $job->idmachineno }}' $jobclass="col-sm-5 form-control">
