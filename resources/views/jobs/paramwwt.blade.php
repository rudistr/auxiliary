...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.paramwwt') }}" method="post">
        @csrf
        ...
        @error ('param7')
          ...
          <input type="text" name="param8" id="param8" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param8')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param8')
          ...
          <input type="text" name="param9" id="param9" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param9')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param9')
          ...
          <input type="text" name="param10" id="param10" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param10')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param10')
