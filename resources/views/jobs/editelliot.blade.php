...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.editelliot',$job) }}" method="post" enctype ="multipart/form-data">
        @csrf
        @method('put')
        ...
        @error ('param26')
          ...
          <div class="form-group">
          <label for="param27">voltage_l2_l3(6300V)</label>
        ...
        @error ('param29')
          ...
          <div class="form-group">
          <label for="param30">motor_line_current_l3(71A)</label>
