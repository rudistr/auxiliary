...
@section('content')
<div class="card">
    <div class="card-header">CVHE-590</div>       
    <div class="card-body">
    <form action="{{ route('jobs.editchillercvhe590',$job) }}" method="post">
        @csrf
        @method('put')
        ...
        <div class="form-group">
          <label for="param9">differential_oil_press(< 150 KPA)</label>
        ...
        @error ('param10')
          ...
          <div class="form-group">
          <label for="param11">oil_tank_Press (KPA)</label>
        ...
        @error ('param14')
          ...
          <div class="form-group">
          <label for="param15">compressor_line_currents_l3(max = 649A)</label>
        ...
        @error ('param16')
          ...
          <div class="form-group">
          <label for="param17">COMPRESSOR START</label>
        ...
        @error ('param17')
          ...
          <div class="form-group">
          <label for="param18">COMPRESSOR RUNNING HOUR</label>
        ...
        @error ('param18')
          ...
          <div class="form-group">
          <label for="param19">winding_temp_w1 (< 80c)</label>
        ...
        @error ('param19')
          ...
          <div class="form-group">
          <label for="param20">Winding Temp W2 (< 80C)</label>
        ...
        @error ('param20')
          ...
          <div class="form-group">
          <label for="param21">Winding Temp W3(< 80C)</label>
        ...
        @error ('param21')
          ...
          <div class="form-group">
          <label for="param22">EVAPORATOR WTR TEMP IN (< 15C)</label>
        ...
        <div class="form-group">
          <label for="param23">EVAPORATOR WTR TEMP OUT (< 9C)</label>
        ...
        @error ('param23')
          ...
          <div class="form-group">
          <label for="param24">CONDENSATOR WTR TEMP IN (< 35C)</label>
        ...
        @error ('param24')
          ...
          <div class="form-group">
          <label for="param25">CONDENSATOR WTR TEMP OUT (< 35C)</label>
        ...
        @error ('param25')
          ...
          <div class="form-group">
          <label for="param26">CURRENT DRAW (< 105%)</label>
