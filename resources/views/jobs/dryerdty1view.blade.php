...
@section('content')
<div class="container">
<a href="{{ route('jobs.dryerdty1')  }}" class="btn btn-success">Create</a>
<div class="row g-3 align-items-center mt-2">
  <div class="col-auto">
 <form action="{{ route('jobs.dryerdty1view') }}" method="GET">        
  ...
  <button type="submit" class="btn btn-primary col-md-4"><i class="fa fa-print"></i> Filter </button>
    ...
    <div class="card-header">Dryer DTY1</div>       
    <div class="card-body">
    <table class="table table-dark table-striped">        
     <thead>
         <tr>
           ...
           <th>Time</th>
           <th>Machine No.</th>
           <th>INLET TEMP(Max:< 50C)</th>           
           <th>OUTLET_TEMP(Max:  10C)</th>
           <th>EVAP TEMP(Max:5C)</th>
           <th>CDS TEMP(Max:  50C)</th>
           <th>FRESS.FREON(4-6Bar)</th>
           <th>OUTLET TEMP(Max:50C)</th>
           <th>DRAINT CONDENSATE</th>
...
<tbody>
    @foreach($datajobs as $index => $job)
     ...
     <td>{{ $job->remarks }}</td>
     <td>
       <a href="{{ route('jobs.editdryerdty1',$job->id) }}" class="btn btn-primary btn-sm">Edit</a>       
     </td>                  
    <tr>
    @endforeach
</tbody>
