...
@section('content')
<div class="container">
<a href="{{ route('jobs.paramwwt')  }}" class="btn btn-success">Create</a>
<div class="row g-3 align-items-center mt-2">
  <div class="col-auto">
 <form action="{{ route('jobs.paramwwtview') }}" method="GET">        
  ...
  <button type="submit" class="btn btn-primary col-md-4"><i class="fa fa-print"></i> Filter </button>
    ...
    <div class="card-header">PARAMWWT VIEW</div>       
    <div class="card-body">
...
<tbody>
    @foreach($datajobs as $index => $job)
     ...
     <td>{{ $job->spv }}</td>
     <td>
       <a href="{{ route('jobs.editparamwwt',$job->id) }}" class="btn btn-primary btn-sm">Edit</a>       
     </td>                  
    <tr>
    @endforeach
</tbody>
