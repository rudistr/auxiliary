...
@section('content')
<div class="container">
<a href="{{ route('jobs.ahu_spinning2')  }}" class="btn btn-success">Create</a>
<div class="row g-3 align-items-center mt-2">
  <div class="col-auto">
 <form action="{{ route('jobs.ahu_spinning2view') }}" method="GET">        
  ...
  <button type="submit" class="btn btn-primary col-md-4"><i class="fa fa-print"></i> Filter </button>
    ...
    <div class="card-header">AHU SPINNING2</div>       
    <div class="card-body">
    <table class="table table-dark table-striped">        
     <thead>
         <tr>
           ...
           <th>dp_bag_filter_supply(Max:250Pa)</th>
           <th>rh_supply (Max:60-90%)</th>
           <th>temp_supply(C)</th>
           <th>dew_point_control(C)</th>
           <th>motor_line_current_tu(Max:120C)</th>
           <th>Motor Line Current QA(Max:150A)</th>
           <th>kwh_tu</th>
           <th>kwh_qa</th>
...
<tbody>
    @foreach($datajobs as $index => $job)
     ...
     <td>{{ $job->remarks }}</td>
     <td>
       <a href="{{ route('jobs.editahu_spinning2',$job->id) }}" class="btn btn-primary btn-sm">Edit</a>       
     </td>                  
    <tr>
    @endforeach
</tbody>
