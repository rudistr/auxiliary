...
<div class="card">
    ...
    <div class="card-body">
    <form action="{{ route('jobs.editwwt',$job) }}" method="post">
        @csrf
        @method('put')
        ...
        @error ('param16')
          ...
          <select name="param17" id="param17"  class="col-sm-5 form-control"> 
             ...
             <option value="{{ $aux_categoryvx->id }}"  @if($aux_category->id==$job->param17) selected='selected' @endif >{{ $aux_categoryvx->description }}</option>             
             @endforeach
          </select>
        </div>
        @error ('param17')
          ...
          @foreach($aux_categoryvxs as $aux_categoryvx)
          <option value="{{ $aux_categoryvx->id }}"  @if($aux_category->id==$job->param18) selected='selected' @endif >{{ $aux_categoryvx->description }}</option>             
             @endforeach
          </select>
        </div>
        @error ('param18')
          ...
          @foreach($aux_categoryvxs as $aux_categoryvx)
          <option value="{{ $aux_categoryvx->id }}"  @if($aux_category->id==$job->param19) selected='selected' @endif >{{ $aux_categoryvx->description }}</option>             
             @endforeach
          </select>
        </div>
        @error ('param19')
          ...
          @foreach($aux_categoryvxs as $aux_categoryvx)
          <option value="{{ $aux_categoryvx->id }}"  @if($aux_category->id==$job->param20) selected='selected' @endif >{{ $aux_categoryvx->description }}</option>             
             @endforeach
          </select>
        </div>
        @error ('param20')
          ...
          @foreach($aux_categoryvxs as $aux_categoryvx)
          <option value="{{ $aux_categoryvx->id }}"  @if($aux_category->id==$job->param21) selected='selected' @endif >{{ $aux_categoryvx->description }}</option>             
             @endforeach
          </select>
        </div>
        @error ('param21')
          ...
          <input type="text" name="param22" id="param22" value="{{ $job->param22 }}" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param22')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param22')
          ...
          <input type="text" name="param23" id="param23" value="{{ $job->param23 }}"  class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param23')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param23')
          ...
          <input type="text" name="param24" id="param24" value = "{{ $job->param24 }}" class="form-control @error('') is invalid @enderror">
        </div>
        @error ('param24')
           <div class="mt-2 text-danger">{{ $message }}</div>
          @enderror ('param24')
