...
@section('content')
<div class="container">
<a href="{{ route('jobs.dryerfd1600plf2')  }}" class="btn btn-success">Create</a>
<div class="row g-3 align-items-center mt-2">
  <div class="col-auto">
 <form action="{{ route('jobs.dryerfd1600plf2view') }}" method="GET">        
  ...
  <button type="submit" class="btn btn-primary col-md-4"><i class="fa fa-print"></i> Filter </button>
    ...
    <div class="card-header">Dryer FD 1600 </div>       
    <div class="card-body">
    <table class="table table-dark table-striped">        
     <thead>
         <tr>
           ...
           <th>DEW_POINT_TEMP(Max: < 10C)</th>
           <th>EVAP TEMP(Max:<=6C) </th>
           <th>CDS TEMP(Max: < 50C)</th>
           <th>CONDENSATE DRAIN</th>
...
<tbody>
     ...
     <td>{{ $job->remarks }}</td>
     <td>       
       <a href="{{ route('jobs.editdryerfd1600plf2',$job->id) }}" class="btn btn-primary btn-sm">Edit</a>       
     </td>                  
    <tr>
    @endforeach
</tbody>
