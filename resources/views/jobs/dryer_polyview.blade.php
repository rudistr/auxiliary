...
@section('content')
<div class="container">
<a href="{{ route('jobs.dryer_poly')  }}" class="btn btn-success">Create</a>
<div class="row g-3 align-items-center mt-2">
  <div class="col-auto">
 <form action="{{ route('jobs.dryer_polyview') }}" method="GET">        
  ...
  <button type="submit" class="btn btn-primary col-md-4"><i class="fa fa-print"></i> Filter </button>
    ...
    <div class="card-header">Dryer Poly View</div>       
    <div class="card-body">
     ...
     <thead>
         <tr>
          <th>No</th>
           ...
           <th>EVAP TEMP S(Max:<=6C)</th>
           <th>CDS TEMPCDS TEMP(Max: < 50C)</th>
...
<tbody>
    @foreach($datajobs as $index => $job)
     ...
     <td>{{ $job->remarks }}</td>
     <td>
       <a href="{{ route('jobs.editdryer_poly',$job->id) }}" class="btn btn-primary btn-sm">Edit</a>       
     </td>                  
    <tr>
    @endforeach
</tbody>
